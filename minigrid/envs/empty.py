...
class EmptyEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        if self.costs:
            ...
            self.put_obj(Hazard(), width - 5, height - 3)
            self.put_obj(Hazard(), width - 6, height - 3)

            self.put_obj(Hazard(), width - 8, height - 9)
            self.put_obj(Hazard(), width - 4, height - 9)
            self.put_obj(Hazard(), width - 3, height - 11)
            self.put_obj(Hazard(), width - 8, height - 13)
            self.put_obj(Hazard(), width - 12, height - 14)
            self.put_obj(Hazard(), width - 12, height - 9)
